...
CFLAGS	:=	-g0 -Wall -O2 -mword-relocations \
...
export LIBPATHS	:=	$(foreach dir,$(LIBDIRS),-L$(dir)/lib) -L$(DEVKITARM)/lib/gcc/arm-none-eabi/13.2.0 -L$(DEVKITARM)/arm-none-eabi/lib/armv6k/fpu\
